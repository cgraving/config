...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/5d/r2_lxt3x68sbvpv17gjwltd80000gn/0//com.apple.notificationcenter/db2/db" 'select * from app'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/cgraving/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/cgraving/.mailcheckrc"
# }
